...
myFont :: String
myFont = "xft:Monofur Nerd Font Mono:regular:size=16:antialias=true:hinting=true"
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((modm,		    xK_t     ), spawn "time_date")
    
    -- Give Subscriber Count
    , ((modm .|. shiftMask, xK_s     ), spawn "subcount")
    
    -- Show Dmenu Prompt For Editing Scripts
    , ((modm,		    xK_s     ), spawn "config-sel")
    
    -- Show Dmenu Prompt For Executing Scripts
    , ((modm,		    xK_e     ), spawn "execscripts")
